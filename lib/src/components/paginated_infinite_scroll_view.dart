...
class _PaginatedInfiniteScrollViewState<T>
    extends State<PaginatedInfiniteScrollView<T>> {
  ...
  Widget itemBuilder(BuildContext context, int index) {
    if (items.length < widget.maxLimit
        && index + widget.pageThreshold >= items.length) {
      lockedLoadNext();
